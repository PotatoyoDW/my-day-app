...
【炒め料理の油の想定量】
- 野菜炒め（家庭料理）：油量が指定されていない場合、植物油 小さじ1（4g、37kcal）を想定する。大さじ2以上は想定しない。
- 肉・魚の炒め物：油量が指定されていない場合、植物油 小さじ1〜大さじ1（4〜13g、37〜119kcal）を想定する。
- 「油なし」「ノンオイル」「フライパンで空焼き」の記載がある場合は油0で計算する。

【刺身・魚介類の標準カロリー値（100gあたり）】
文部科学省成分表の値を必ず参照すること：
- かつお（生）：114kcal、P:25.8g、F:0.5g、C:0.1g
- まぐろ赤身：125kcal、P:26.4g、F:1.4g、C:0.1g
- まぐろ中トロ：251kcal、P:26.0g、F:15.8g、C:0.1g
- さわら（生）：177kcal、P:20.1g、F:9.7g、C:0.1g
- 真鯛（天然・生）：142kcal、P:20.6g、F:5.8g、C:0.1g
- 真鯛（養殖・生）：194kcal、P:20.9g、F:11.2g、C:0.1g
- サーモン/アトランティックサーモン：204kcal、P:20.1g、F:13.4g、C:0.1g
- 信州サーモン：約190〜210kcal（脂乗りの多い養殖サーモン）
- ぶり（生）：257kcal、P:21.4g、F:17.6g、C:0.4g
- ひらめ（天然・生）：103kcal、P:20.0g、F:2.0g、C:0.0g
- ヤリイカ・スルメイカ（生）：88kcal、P:17.9g、F:1.0g、C:0.4g
- えび（ブラックタイガー等）：82kcal、P:18.4g、F:0.3g、C:0.0g
- たこ（生）：76kcal、P:16.4g、F:0.7g、C:0.1g

【刺身の付け合わせ（つま・薬味）の標準カロリー値】
これらはごく少量しか食べないため、カロリーへの影響は非常に小さい：
- つま（大根の千切り）：18kcal/100g → 5gで約1kcal
- わさび（生／おろし）：44kcal/100g → 小さじ1(5g)で約2kcal
- 海苔（焼き海苔）：188kcal/100g → 1枚(3g)で約6kcal
- しょうが（おろし）：43kcal/100g → 小さじ1で約2kcal
- 刺身の盛り合わせに「つま・わさび・海苔」がついていても、合計で10kcal未満が現実的。絶対に5gで277kcalなどの異常値を出さないこと。

【市販の特定商品の栄養値】
商品名が記載されている場合は以下の正確な値を使うこと：
- 味の素「プロテインからあげ」：133kcal/100g、P:17.6g、F:3.2g、C:8.4g
  → 「プロテイン」「低カロリー」「減脂」などの文言がついた商品は、通常の同種商品より大幅に低カロリーである可能性が高い。必ずその商品の特性を考慮すること。
  → 通常の唐揚げ（約220kcal/100g）で計算しないこと。`;
